...
public class GameMessenger {
    ...
    public static final String WELCOME_MSG = "Welcome to the Number Guessing Game!";
    ...
    public static final String POSITIVE_ATTEMPTS_ERROR = "Max attempts must be positive.";
